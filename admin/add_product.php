...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    // Insert product
    $db->query('INSERT INTO products (name, description, price, original_price, category_id, stock, image, is_active) 
                VALUES (:name, :description, :price, :original_price, :category_id, :stock, :image, :is_active)');
            ...
            <div class="main-content">
                ...
                <div class="form-card">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Recommended: 500x500 pixels, max 2MB</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Image Upload Tips:</label>
                                    <ul class="text-muted">
                                        <li>Use high-quality images</li>
                                        <li>Square images work best</li>
                                        <li>Make sure product is clearly visible</li>
                        ...
                        <div class="mt-4">
                            <button type="submit" name="add_product" class="btn btn-gold btn-lg">
        ...
        if (priceInput && originalPriceInput) {
            priceInput.addEventListener('change', function() {
                ...
                if (original && price > original) {
                    alert('Sale price should be lower than original price!');
                    this.value = original - 1;
                }
            });
